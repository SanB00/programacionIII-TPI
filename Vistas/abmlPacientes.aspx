...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">   
    ...
    <table id="bloqueAgregarPaciente" runat="server" visible="false" border="0">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td style="text-align: right">&nbsp;<asp:Button ID="btnAgregar" runat="server" style="text-align: left" Text="Agregar" OnClick="btnAgregar_Click" />
                <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" OnClick="btnCancelar_Click" />
            </td>
        </tr>
    </table>

    <asp:Label ID="lbl_Mensaje_BusquedasP" runat="server"></asp:Label>

    <br />
    Buscar por DNI: <asp:TextBox ID="txtBuscarPorDni" runat="server" />
    
    &nbsp;
    <asp:Button ID="btnBuscarPoDni" runat="server" OnClick="btnBuscarPoDni_Click" Text="Buscar" />
&nbsp; Buscar por Nombre:&nbsp;
    <asp:TextBox ID="txtBuscarPorNombre" runat="server"></asp:TextBox>
&nbsp;
    <asp:Button ID="btnBuscarNombre" runat="server" OnClick="btnBuscarNombre_Click" Text="Buscar" />
&nbsp;Buscar por Apellido:&nbsp;&nbsp;
    <asp:TextBox ID="txtBuscarApellido" runat="server"></asp:TextBox>
&nbsp;&nbsp;
    <asp:Button ID="btnBuscarPorApellido" runat="server" OnClick="btnBuscarPorApellido_Click" Text="Buscar" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnLimpiarP" runat="server" OnClick="btnLimpiarP_Click" Text="Limpiar" />
    ...
    <td style="vertical-align:top; padding-right:20px;">
            Sexo:<asp:RadioButtonList ID="rdFiltrarSexoP" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rdFiltrarSexoP_SelectedIndexChanged">
                <asp:ListItem Value="M">Masculino</asp:ListItem>
                <asp:ListItem Value="F">Femenino</asp:ListItem>
            </asp:RadioButtonList>
            Estado:<asp:RadioButtonList ID="rdFiltrarEstadoP" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rdFiltrarEstadoP_SelectedIndexChanged">
