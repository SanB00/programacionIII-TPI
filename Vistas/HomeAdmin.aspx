    ...
    &nbsp;<table class="auto-style1"style="width: 100%; max-width: 600px; border-collapse: separate; border-spacing: 15px; font-family: Arial, sans-serif;">
            <tr>
                <td class="auto-style2" style="border: 1px solid #d9e2ec; padding: 30px; text-align: center; width: 50%;">
                    <asp:LinkButton ID="lbMedicos_admin" runat="server" Font-Bold="True" ForeColor="#102a43" Font-Size="Medium" style="text-decoration: none;">Ir a Médicos</asp:LinkButton>
                </td>
                <td class="auto-style2" style="border: 1px solid #d9e2ec; padding: 30px; text-align: center; width: 50%;">
            ...
            <tr>
                <td class="auto-style2" style="border: 1px solid #d9e2ec; padding: 30px; text-align: center; width: 50%;">
                    <asp:LinkButton ID="lbPacientes_admin" runat="server" Font-Bold="True" ForeColor="#102a43" Font-Size="Medium" style="text-decoration: none;">Ir a Pacientes</asp:LinkButton>
                </td>
                <td class="auto-style2" style="border: 1px solid #d9e2ec; padding: 30px; text-align: center; width: 50%;">
